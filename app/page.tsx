...
export default function Home() {
  return (
    <div className="bg-stone-900 min-h-screen bg-[url('/lighthouse.png')] bg-contain bg-no-repeat bg-center lg:bg-[url('/5566.svg')] lg:bg-contain lg:bg-no-repeat lg:bg-center w-[99vw] h-[100vh] ">
