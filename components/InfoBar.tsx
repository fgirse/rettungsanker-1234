...
export default function InfoBar() {
  return (
    <>
      <div className="h-[4vh] w-[100vw] z-[30] top-[10vh] md:top-[8vh] lg:top-[12vh] lg:h-[4vh] mx-auto flex flex-row items-center justify-start gap-x-6 bg-yellow-600">
        <div className=" flex flex-row gap-x-2 px-2 lg:flex-row lg:items-center lg:justify-evenly">
          ...
          <p className="mt-[2.9px] font-mono text-[.66rem] text-gray-100 md:text-[.77rem] lg:text-[.77rem] xl:text-[.9rem]  2xl:text-[1.13rem]">
            0761 383 867 47
          </p>
        </div>
        ...
        <div className="flex flex-row items-center gap-x-1 lg:flex lg:flex-row lg:items-center lg:justify-center lg:gap-x-1">
          ...
          <p className="font-mono text-[.66rem] text-gray-100 lg:text-[.66rem] xl:text-[.9rem]  2xl:text-[1.1rem]">
