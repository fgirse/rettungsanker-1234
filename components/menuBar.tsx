...
const Navbar1 = () => {
  return (
    <section className="py-32 lg:h-24 bg-stone-700 lg:bg-[url('/Wood3.svg')] lg:bg-cover lg:bg-no-repeat lg:bg-center">
      <div className="container">
        <nav className="hidden justify-between items-center lg:flex">
          <div className="py-3 flex items-center gap-6">
            <div className="mt-7 flex items-center gap-x-12">
              <Image
                src={LogoNeu}
            ...
            <div className="flex items-end">
              ...
              <NavigationMenu>
                <NavigationMenuList>
                  <NavigationMenuItem className="text-white text-shadow-lg text-[1.33rem]">
                    <NavigationMenuTrigger className="flex items-end">
                      <div className="flex items-end gap-2">
                      <Image
                        src={Bulleye}
                        className="mt-5 w-8 lg:w-16"
                        alt="logo"
                        width={100}
                        height={100}
                      />
                      <span className=" flex items-center border text-white text-shadow-lg text-[1.33rem] uppercase">über uns</span>
                      </div>
                    </NavigationMenuTrigger>
                    <NavigationMenuContent>
                  ...
                  <NavigationMenuItem className="text-white">
                    <div className="flex items-end gap-2">
                      <Image
                        ...
                        height={100}
                      />
                      <NavigationMenuTrigger className="flex items-center text-[1.33rem] uppercase border">drinks & snacks</NavigationMenuTrigger>
                    </div>
                    <NavigationMenuContent>
                      <ul className="w-80 p-3">
                        <NavigationMenuLink>
